...
trait Dao {
	...
	def addGameEntity(name: String, location: String, x: Double, y: Double): GameEntity

	def deleteGameEntity(id: Long): Boolean

	def updateGameEntity(id: Long, name: String, location: String, x: Double, y: Double): Boolean
}
